...
## <a name="type1">Type=1 (0x01) - Warning</a>
...
## <a name="type2">Type=2 (0x02) - Alarm occurred</a>
...
## <a name="type3">Type=3 (0x03) - Alarm sound on/off</a>
...
## <a name="type4">Type=4 (0x04) - Alarm light on/off</a>
...
## <a name="type5">Type=5 (0x05) - Power on/off</a>
...
## <a name="type6">Type=6 (0x06) - Emergency Stop</a>
...
## <a name="type7">Type=7 (0x07) - Emergency Pause</a>
...
## <a name="type8">Type=8 (0x08) - Emergency Reset</a>
...
## <a name="type9">Type=9 (0x09) - Emergency Resume</a>
...
## <a name="type10">Type=10 (0x0A) - Arm</a>
    VSCP_TYPE_ALARM_ARM 
...
## <a name="type11">Type=11 (0x0B) - Disarm</a>
