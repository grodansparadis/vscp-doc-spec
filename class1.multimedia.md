...
## <a name="type1">Type=1 (0x01) - Playback</a>
...
## <a name="type2">Type=2 (0x02) - NavigatorKey English</a>
...
## <a name="type3">Type=3 (0x03) - Adjust Contrast</a>
...
## <a name="type4">Type=4 (0x04) - Adjust Focus</a>
...
## <a name="type5">Type=5 (0x05) - Adjust Tint</a>
...
## <a name="type6">Type=6 (0x06) - Adjust Color Balance</a>
...
## <a name="type7">Type=7 (0x07) - Adjust Brightness</a>
...
## <a name="type8">Type=8 (0x08) - Adjust Hue</a>
...
## <a name="type9">Type=9 (0x09) - Adjust Bass</a>
...
## <a name="type10">Type=10 (0x0A) - Adjust Treble</a>
...
## <a name="type11">Type=11 (0x0B) - Adjust Master Volume</a>
...
## <a name="type12">Type=12 (0x0C) - Adjust Front Volume</a>
...
## <a name="type13">Type=13 (0x0D) - Adjust Center Volume</a>
...
## <a name="type14">Type=14 (0x0E) - Adjust Rear Volume</a>
...
## <a name="type15">Type=15 (0x0F) - Adjust Side Volume</a>
...
## <a name="type16">Type=16 (0x10) - Reserved</a>
    VSCP_TYPE_MULTIMEDIA_RESERVED16
These are reserved for other future speaker combinations
----

## <a name="type17">Type=17 (0x11) - Reserved</a>
    VSCP_TYPE_MULTIMEDIA_RESERVED17
These are reserved for other future speaker combinations
----

## <a name="type18">Type=18 (0x12) - Reserved</a>
    VSCP_TYPE_MULTIMEDIA_RESERVED18
These are reserved for other future speaker combinations
----

## <a name="type19">Type=19 (0x13) - Reserved</a>
    VSCP_TYPE_MULTIMEDIA_RESERVED19
These are reserved for other future speaker combinations
----

## <a name="type20">Type=20 (0x14) - Select Disk</a>
...
## <a name="type21">Type=21 (0x15) - Select Track</a>
...
## <a name="type22">Type=22 (0x16) - Select Album/Play list</a>
...
## <a name="type23">Type=23 (0x17) - Select Channel</a>
...
## <a name="type24">Type=24 (0x18) - Select Page</a>
...
## <a name="type25">Type=25 (0x19) - Select Chapter</a>
...
## <a name="type26">Type=26 (0x1A) - Select Screen Format</a>
...
## <a name="type27">Type=27 (0x1B) - Select Input Source</a>
...
## <a name="type28">Type=28 (0x1C) - Select Output</a>
...
## <a name="type29">Type=29 (0x1D) - Record</a>
...
## <a name="type30">Type=30 (0x1E) - Set Recording Volume</a>
...
## <a name="type40">Type=40 (0x28) - Tivo Function</a>
...
## <a name="type50">Type=50 (0x32) - Get Current Title</a>
...
## <a name="type51">Type=51 (0x33) - Set media position in milliseconds</a>
...
## <a name="type52">Type=52 (0x34) - Get media information</a>
...
## <a name="type53">Type=53 (0x35) - Remove Item from Album</a>
...
## <a name="type54">Type=54 (0x36) - Remove all Items from Album</a>
...
## <a name="type55">Type=55 (0x37) - Save Album/Play list</a>
...
## <a name="type60">Type=60 (0x3C) - Multimedia Control</a>
...
## <a name="type61">Type=61 (0x3D) - Multimedia Control response</a>
